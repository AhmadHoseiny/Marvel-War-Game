...
public abstract class Champion implements Damageable,Comparable {
	...
	public String toString() {
		...
		x += "<br>"+"}";
		return "<html>"+"name=" + name +"<br>"+ "maxHP=" + maxHP+"<br>"+ "mana=" + mana +"<br>"+ "maxActionPointsPerTurn="
				+ maxActionPointsPerTurn+"<br>"+ "attackRange=" + attackRange+"<br>"+ "attackDamage=" + attackDamage+"<br>"
				+ "speed=" + speed+"<br>"+ "abilities=" + x +"</html>" ;
